                        ...
                        <tr>
                          <th class="small-12 large-12 columns first last">
                            <table>
                              <tr>
                                <th>
                                  <img src="https://cdn.shopify.com/s/files/1/2256/3751/files/logo-bienvenida.png?3404579864033650151" alt="" style="width: 500px; height: auto; display: block; margin: 0 auto; padding-top: 50px"/>
                                  <table class="callout">
                                    <tr>
                                      <th class="primary" style="background-color: #fd6a15; border-radius: 20px; box-shadow: 3px 3px 2px 1px rgba(0,0,0, .3); margin-top: 40px; text-align: center">
                                         
                                          <h1 style="margin: 0; font-family: 'Dosis', sans-serif !important; font-size: 33px; color: #fd6a15; text-align: center;  background-color: white"> Reestablece tu contraseña </h1>
                                          <a href="{{url()}}/recuperar-contraseña/{{$token}}" style="color: #fd6a15; text-align: center; border-radius: 20px; background-color: white; margin: 10px auto; padding: 10px 8px; display: block; width: 300px"> Cambiar contraseña </a>
                                         
                                      </th>
                                    </tr>
                                     <tr>
                                      <th class="primary">
                                         <img src="https://cdn.shopify.com/s/files/1/2256/3751/files/momento.png?14655240693994210511" alt="" style="width: 500px; height: auto; display: block; margin: 0 auto; padding-top: 0px"/>
                                      </th>
                                    </tr>
                                  </table>
                                </th>
