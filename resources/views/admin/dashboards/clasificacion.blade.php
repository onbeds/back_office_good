...
@section('titulo','Dashboard Clasificacion')

@section('content')
<section class="invoice">
<div class="page-header no-breadcrumb font-header"><i class="fa fa-truck"></i> Rol Clasificacion</div>  
    ...
    <div class="panel-body">
          ...
          <div class="panel panel-default bg-info panel-stat no-icon open-alerts" data-toggle="modal" data-target=".modal-flip-vertical">
                <div class="panel-body content-wrap">
                  ...
                  <div class="detail text-right">
                    <div class="text-upper">Ordenes pendientes por clasificar</div>
      ...
      <div class="row">
        <div class="col-xs-12">
                  ...
                  <tbody>
                      @foreach ($ordenes as $orden)
                        <tr>
                          ...
                          <td>
                            @if ($orden->recogida) 
                               {{ $orden->recogida->numero }}
                            @endif
                          </td>
                          <td>
                            @if ($orden->os_cliente) 
                               {{ $orden->recogida->os_cliente }}
                            @endif
                          </td>
                          <td>
                          ...
                          <td>
                              <?echo forden_servicios($orden->id,6)?>
                          </td>
                          <td>
                          ...
                          <td>
                            ...
                            <td align="center">
                               <button class="btn btn-primary btn-xs btn-detail open-modal" value="{{$orden->id}}">Registrar Entrada Clasificaci&oacute;n</button>
                            </td>
                        </tr>
                      @endforeach
                  </tbody>
          ...
          {!! Form::open(array('url' => 'admin/ordenes/clasificacion/update','class'=>'form-control'))!!}
          <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" id="btn-save" value="add">Registrar Inicio Clasificaci&oacute;n</button>
 ...
 <script type="text/javascript">
   ...
   $('.open-modal').click(function(){
    ...
    $('.open-alerts').click(function(){
              $("#reporte").val(4);
              $("#title_reporte").html("Ordenes pendientes por clasificar con mas de 24 horas");
              tabla.ajax.reload();
    });
